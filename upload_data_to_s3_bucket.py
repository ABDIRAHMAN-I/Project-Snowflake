...
# Parameters
bucket_name = 'my-snowflake-project-bucket0'  # Replace with your bucket name
local_folder = 'assets/datasets/Transformed_tables'       # Folder containing your CSV files
s3_folder = 'transformed_data/'            # S3 folder path
...
try:
    ...
    for file_name in os.listdir(local_folder):
        if file_name.endswith('.csv'):  # Only process CSV files
            ...
            s3_file_path = s3_folder + file_name                     # S3 path including folder and file name
